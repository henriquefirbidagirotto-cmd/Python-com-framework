...
di = dia =='sabado' or dia == 'domingo'
d1 = di == True and print('fechado')
d2 = di != True and print('aberto')

ve = int(input('Horario:'))

hora = ve > 9 and ve <18
ver_hora = hora != True and print('fechado!')
ver_hora2 = hora == True and print('aberto!')
